...
return {
  ...
  {
    "fallout4_improved",
    name = "fallout4_improved",
    dir = "~/.config/nvim/lua/plugins/themes/fallout4_improved.nvim",
    dev = true,
    config = function()
      require("fallout4_improved").setup({
        -- NOTE: also have fallout4_default
        style = "fallout4_enhanced",
        transparent = true,
      })
      vim.cmd.colorscheme("fallout4_improved")
    end,
  },
}
